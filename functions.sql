...
create or replace function numplots (cvar double precision,
       maxplots integer,
       err double precision default 10.0,
       tval double precision default 1.96)
returns integer as
$$
from numpy import round as rd
v1 = tval**2 * (cvar*100)**2
v2 = err**2 +(v1/maxplots)
return int(rd(v1/v2))
$$
